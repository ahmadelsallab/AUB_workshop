...
%     CONFIG_strParams.bBreadthMapping = 1;
    ...
    CONFIG_strParams.nInitialNumLayers = 1;% Execluding input and top/targets/output layer
    
    % The architecture of the initial net
    CONFIG_strParams.vInitialLayersWidths = [2000];
    ...
    CONFIG_strParams.nFinalFirstLayerWidth = 2000;
    
    % In case of depth, this is the final depth required.
    CONFIG_strParams.nFinalNumLayers = 1;
