...
%     CONFIG_strParams.bBreadthMapping = 1;
    ...
    CONFIG_strParams.nInitialNumLayers = 5;% Execluding input and top/targets/output layer
    
    % The architecture of the initial net
    CONFIG_strParams.vInitialLayersWidths = [500 500 500 500 2000];
    ...
    CONFIG_strParams.nFinalNumLayers = 5;
