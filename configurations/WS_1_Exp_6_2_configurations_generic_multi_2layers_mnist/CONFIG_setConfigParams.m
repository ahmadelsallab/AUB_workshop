...
function [CONFIG_strParams] = CONFIG_setConfigParams()
	...
	CONFIG_strParams.sDatasetFilesPath = '..\..\datasets\MNIST';
...
%     CONFIG_strParams.bBreadthMapping = 1;
    ...
    CONFIG_strParams.nInitialNumLayers = 2;% Execluding input and top/targets/output layer
    
    % The architecture of the initial net
    CONFIG_strParams.vInitialLayersWidths = [500 2000];
    ...
    CONFIG_strParams.nFinalFirstLayerWidth = 500;
    
    % In case of depth, this is the final depth required.
    CONFIG_strParams.nFinalNumLayers = 2;
