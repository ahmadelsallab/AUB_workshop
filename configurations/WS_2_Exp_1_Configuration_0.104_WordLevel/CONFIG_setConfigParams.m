...
%     CONFIG_strParams.bBreadthMapping = 1;
    ...
    % The architecture of the initial net-->obtained by running
    % get_max_num_ones.m in Generic Classifier_0.13
    CONFIG_strParams.vInitialLayersWidths = [42 42 42 42 42];
    %CONFIG_strParams.vInitialLayersWidths = [6 6 6];
    ...
    CONFIG_strParams.nFinalFirstLayerWidth = 42*2;
    ...
    CONFIG_strParams.nBPNumEpochsBeforeMapping = 30;
